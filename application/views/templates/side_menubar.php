      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($user_permission): ?>
          ...
          <?php if(in_array('updateCompany', $user_permission)): ?>
            <li id="companyNav"><a href="<?php echo base_url('company/') ?>"><i class="fa fa-files-o"></i> <span>Compañia</span></a></li>
          <?php endif; ?>
        ...
        <?php if(in_array('updateSetting', $user_permission)): ?>
          <li><a href="<?php echo base_url('users/setting/') ?>"><i class="fa fa-wrench"></i> <span>Configuraciones</span></a></li>
        <?php endif; ?>
